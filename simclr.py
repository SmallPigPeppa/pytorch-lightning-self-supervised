...
class SimCLR(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--dataset", type=str, default="imagenet", help="stl10, cifar10, imagenet")
        parser.add_argument("--data_dir", type=str, default="/share/datasets/torch_ds/imagenet/", help="path to download data")
        # parser.add_argument("--meta_dir", type=str, default=".", help="path to meta.bin")
